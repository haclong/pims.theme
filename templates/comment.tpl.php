 ...
 */
?>
<section class="<?php print $classes; ?> clearfix margin20 no-margin-left no-margin-right no-margin-bottom"<?php print $attributes; ?>>
    <div class="flexbox">
        ...
        <div class="comment-body block-shadow padding20 popover marker-on-left">
            ...
            <?php if ($new): ?> <span class="tag success text-small"><span class="icon mif-bell"></span> <?php print $new; ?></span><?php endif; ?>
